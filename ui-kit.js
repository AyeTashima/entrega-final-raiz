...
/* ── Paneles de contenido: mismo comportamiento que curso-principiantes.js ── */
function initContenidosPanelsDemo() {
  const panels = document.querySelectorAll('#contenidosPanelsKit [data-panel]');
